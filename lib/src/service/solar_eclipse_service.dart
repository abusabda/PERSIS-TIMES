...
import '../core/math/safe_math.dart';
...
class SolarEclipseService {
  ...
  SolarEclipseLocalResult? solarEclipseLocal({
    ...
    final deltaTDays = (bessel.deltaT ?? 0) / 86400.0;
    ...
    return SolarEclipseLocalResult(
      ...
      // === WAKTU UT (sudah terkoreksi deltaT) ===
      u1UT: jdSolarU1,
      u2UT: jdSolarU2,
      mxUT: jdSolarMx,
      u3UT: jdSolarU3,
      ...
      // === WAKTU TD (UT + deltaT) ===
      u1TD: jdSolarU1 + deltaTDays, // ✅ UT + deltaT = TD
      u2TD: jdSolarU2 != null ? jdSolarU2 + deltaTDays : null,
      mxTD: jdSolarMx + deltaTDays,
      u3TD: jdSolarU3 != null ? jdSolarU3 + deltaTDays : null,
      u4TD: jdSolarU4 + deltaTDays,
      ...
      // === EPHEMERIS (DIPISAH) ===
      sunEphemeris: EclipseEphemerisBody(
        ra: raS / 15,
        dec: dcS,
        sd: sdS,
        hp: hpS,
      ),
      moonEphemeris: EclipseEphemerisBody(
        ra: raM / 15,
        dec: dcM,
        sd: sdM,
        hp: hpM,
      ...
      for (int bln = 1; bln <= 12; bln++) {
        ...
        hasil.add(
          SolarEclipseGlobalSummary(
            ...
            durasiTotalitas: e.durasiTotalitas,
            lebar: e.lebar,
            besselian: e.besselian,
            sunEphemeris: e.sunEphemeris,
            moonEphemeris: e.moonEphemeris,
          ),
        );
      }
    }
  ...
  List<SolarEclipseLocalSummary> solarEclipseLocalRangeHijri({
    ...
    for (int thn = tahunAwalH; thn <= tahunAkhirH; thn++) {
      for (int bln = 1; bln <= 12; bln++) {
        ...
        // === WAKTU TD (langsung dari field baru) ===
        final u1TD = e.u1TD;
        final u2TD = e.u2TD;
        final mxTD = e.mxTD;
        final u3TD = e.u3TD;
        ...
        // === WAKTU UT (langsung dari field baru) ===
        final u1UT = e.u1UT;
        final u2UT = e.u2UT;
        final mxUT = e.mxUT;
        final u3UT = e.u3UT;
        ...
        // === EPHEMERIS (langsung dari field terpisah) ===
        ...
        final obscuration = e.obscuration;
        final durasiTotal = e.durasiTotalitas;
