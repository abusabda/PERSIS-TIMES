class MoonResult {
  ...
  // Phase & illumination
  final double geoPhaseAngle;
  final double geoIlluminatedFraction;
  final double geoBrightLimbAngle;

  // Sun elongation
  final double geoSunElongation;
  ...
  final double topoPhaseAngleApparent;
  final double topoIlluminatedFractionApparent;
  final double topoBrightLimbAngleApparent;
  ...
  MoonResult({
    ...
    required this.geoPhaseAngle,
    required this.geoIlluminatedFraction,
    required this.geoBrightLimbAngle,

    required this.geoSunElongation,
    ...
    required this.topoPhaseAngleApparent,
    required this.topoIlluminatedFractionApparent,
    required this.topoBrightLimbAngleApparent,
